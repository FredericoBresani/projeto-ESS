...
cucumber_1.defineSupportCode(function ({ Given, When, Then }) {
    ...
    Given(/^entro na página cadastro de pedido$/, () => __awaiter(this, void 0, void 0, function* () {
    ...
    Given(/^os não estão todos preenchidos$/, () => __awaiter(this, void 0, void 0, function* () {
    ...
    When(/^o pedido é cadastrado com nome "pedro - Macbook para monitor" e a aplicação é redirecionada para a página de pedidos$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.get("http://localhost:4200/#/correios/notificacoes");
    }));
    When(/^o pedido é atualizado na página de rotas ao pressionar o botão Atualizar Caminho$/, () => __awaiter(this, void 0, void 0, function* () {
        yield protractor_1.browser.get("http://localhost:4200/#/correios/notificacoes");
        yield protractor_1.element(protractor_1.by.name('atualizacao')).click();
    }));
